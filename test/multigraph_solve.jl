...
DeepQLearning.save(solver, policy1, weights_file=solver.logdir*"/weights.jld", problem_file=solver.logdir*"/problem.jld")
...
DeepQLearning.save(solver, policy2, weights_file=solver.logdir*"/weights.jld", problem_file=solver.logdir*"/problem.jld")
