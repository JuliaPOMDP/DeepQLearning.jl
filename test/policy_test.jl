...
#mlp(s, [8], 4, scope="active_q")#dense(flatten(s), n_outs; activation=identity, scope="active_q")
# mlp(sp, [8], 4, scope="target_q") #dense(flatten(sp), n_outs; activation=identity, scope="target_q")

# q = build_q(s, arch, env, Q_SCOPE)
# target_q = build_q(sp, arch, env, TARGET_Q_SCOPE)

# q = cnn_to_mlp(s, [], [], n_actions(env), scope="active_q" )

# target_q = cnn_to_mlp(sp, [], [], n_actions(env), scope="target_q" )


# q = cnn_to_mlp(s, [(32,[8,8],4),
#                     (64, [4,4],2),
#                      (64, [3,3],1)], [512], n_actions(env), scope="active_q" )
#
# target_q = cnn_to_mlp(sp, [(32,[8,8],4),
#                             (64, [4,4],2),
#                              (64, [3,3],1)
#                   ], [512], n_actions(env), scope="target_q" )
...
# train_var = get_train_vars_by_name("target_q")
...
# replay = ReplayBuffer(env, 500, batch_size)
